(function($) {
    ...
    $(document).ready(function() {
        ...
        $('.photo .bt-nav').on("click", function() {
            ...
            $('.lightbox').html("<div class='hero-fullscreen'><div id='videoContainment'></div><a class='player' data-property=\"{ videoURL:'https://www.youtube.com/watch?v=zvPsanBBXJQ',mute:false,showControls:false,quality:'default',opacity: 1, containment:'#videoContainment',optimizeDisplay: true,loop: true,startAt: 0,autoPlay: true, showYTLogo: false,addRaster: false,realfullscreen: true}\"id='bgndVideo'></a><span class='bt-nav close close-lightbox'><em>Close</em></span></div>");
        ...
        $('.play-video').on('click', function(){
            var currentVideo = this.parentNode.parentNode.querySelector('.video-work');
            $(this).children().toggleClass('fa-pause');
        ...
        {
            $('video').each(function(){
                var prop = ($(this).width() - $(this).width() * 0.3) / $(this).height();
